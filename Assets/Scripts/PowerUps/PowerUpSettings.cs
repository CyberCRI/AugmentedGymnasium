...
public class PowerUpSettings : ScriptableObject
	{
		...
		[Tooltip ("How long the magnetic field will last. If the time is negative or zero, it will last undefinitely.")]
		/// <summary>
		/// How long the magnetic field will last. If the time is negative or zero, it will last undefinitely.
		/// </summary>
		public float magneticFieldTime;
		[Tooltip ("The alpha value of the magnetic field")]
		/// <summary>
		/// The alpha value of the magnetic field
		/// </summary>
		public float magneticAlpha;
